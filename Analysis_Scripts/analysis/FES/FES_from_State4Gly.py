...
# grid related
parser.add_argument('--min',dest='grid_min',type=str,default="-1.0,0.0",help='lower bounds for the grid')
parser.add_argument('--max',dest='grid_max',type=str,default="1.0,8.0",help='upper bounds for the grid')
