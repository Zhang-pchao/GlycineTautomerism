...
# input columns
parser.add_argument('--cv',dest='cv',type=str,default='n1,d1',help='the CVs to be used. Either by name or by column number, starting from 1')
...
# grid related
parser.add_argument('--min',dest='grid_min',type=str,default="-1.5,-10.0",help='lower bounds for the grid')
parser.add_argument('--max',dest='grid_max',type=str,default="1.5,15.0", help='upper bounds for the grid')
